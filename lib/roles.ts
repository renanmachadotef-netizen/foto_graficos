...
export const ROLE_PERMISSIONS: Record<Role, {
  ...
  ADMIN: {
    ...
    allowedRoutes: ["/", "/quotes", "/clients", "/pcp", "/pricing", "/materials", "/machines", "/employees", "/financial", "/settings", "/users"],
  ...
  MANAGER: {
    ...
    allowedRoutes: ["/", "/quotes", "/clients", "/pcp", "/pricing", "/materials", "/financial"],
  ...
  SELLER: {
    ...
    allowedRoutes: ["/", "/quotes", "/clients", "/pricing", "/financial"],
    canManageSettings: false,
    canManageCosts: false,
    canManageUsers: false,
